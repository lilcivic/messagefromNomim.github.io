...
let select = s => document.querySelector(s),
      ...
      offset: 100
		...
		woodColor = '#A63C06',
		treeColor = '#0F7173',
    subm1Str = 'TAP & MOVE YOUR FINGER TO FILL',
...
// Add this line inside your init() function, where you set up your other elements
backgroundMusic.volume = 0.5; // Adjust the volume (0.0 to 1.0) as needed

// Add this line at the end of your init() function to play the music
backgroundMusic.play();

gsap.ticker.fps(20);  // Set the frame rate to 30fps
